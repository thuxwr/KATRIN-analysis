...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(41, 39, "end", "model.stan");
    return reader;
}
...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        try {
            writer__.scalar_lub_unconstrain(0.90000000000000002,1.1000000000000001,A_sig);
        } catch (const std::exception& e) { 
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                A_sig = in__.scalar_lub_constrain(0.90000000000000002,1.1000000000000001,lp__);
            else
                A_sig = in__.scalar_lub_constrain(0.90000000000000002,1.1000000000000001);
            ...
            validate_non_negative_index("pars", "2", 2);
            vector<local_scalar_t__> pars(2);
            stan::math::initialize(pars, DUMMY_VAR__);
            stan::math::fill(pars,DUMMY_VAR__);
            stan::math::assign(pars,static_cast<std::vector<local_scalar_t__> >(stan::math::array_builder<local_scalar_t__ >().add(mass).add(endpoint).array()));
            ...
            validate_non_negative_index("par_std", "nbins", nbins);
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  par_std(static_cast<Eigen::VectorXd::Index>(nbins));
    ...
    void write_array(RNG& base_rng__,
        ...
        double A_sig = in__.scalar_lub_constrain(0.90000000000000002,1.1000000000000001);
